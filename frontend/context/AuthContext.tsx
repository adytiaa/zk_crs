...
interface AuthContextProps {
  user: any | null; // Replace 'any' with your User type from Prisma
  token: string | null;
  login: () => Promise<void>;
  logout: () => void;
  loading: boolean;
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  }, [publicKey, signMessage, connected, fetchCurrentUser]); // Add fetchCurrentUser here
  ...
  }, [/*disconnect*/]); // Add disconnect if using
